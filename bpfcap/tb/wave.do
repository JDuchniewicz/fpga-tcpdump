...
add wave -noupdate -expand -group wr_ctrl -radix hexadecimal /tb_top/dut/write_control/almost_empty
...
add wave -noupdate -expand -group wr_ctrl -radix hexadecimal /tb_top/dut/write_control/control_next
add wave -noupdate -expand -group wr_ctrl -radix hexadecimal /tb_top/dut/write_control/pkt_begin_next
add wave -noupdate -expand -group wr_ctrl -radix hexadecimal /tb_top/dut/write_control/pkt_end_next
...
add wave -noupdate -expand -group fifo /tb_top/dut/fifo_i/clock
add wave -noupdate -expand -group fifo /tb_top/dut/fifo_i/data
add wave -noupdate -expand -group fifo /tb_top/dut/fifo_i/rdreq
add wave -noupdate -expand -group fifo /tb_top/dut/fifo_i/sclr
add wave -noupdate -expand -group fifo /tb_top/dut/fifo_i/wrreq
add wave -noupdate -expand -group fifo /tb_top/dut/fifo_i/almost_empty
add wave -noupdate -expand -group fifo /tb_top/dut/fifo_i/almost_full
add wave -noupdate -expand -group fifo /tb_top/dut/fifo_i/q
add wave -noupdate -expand -group fifo /tb_top/dut/fifo_i/usedw
